...
namespace vt {
    ...
    VtSwapChain::VtSwapChain(VtDevice& deviceRef, VkExtent2D extent, std::shared_ptr<VtSwapChain> _previous)
        : device{ deviceRef }, windowExtent{ extent }, oldSwapChain{ _previous } {
        init();
